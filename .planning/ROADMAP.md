...
- [x] 01-01-PLAN.md — Foundation, audited dependencies, digest, and final forward-compatible evidence envelope

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 01-02-PLAN.md — Doctor CLI, bounded workers, diagnostic admission, and atomic evidence readback

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 01-03-PLAN.md — Native local-Xorg and source/runtime NVML proof

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 01-04-PLAN.md — Immutable self-contained pre-reboot FAIL archive

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 01-05-PLAN.md — Output/GPU mapping spike and pure unique-correlation contract

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 01-06-PLAN.md — Explicit selected-output integration and corrected-host proof
...
- [x] 01-08-PLAN.md — Operator gate and real selected-output one-frame NvFBC proof

**Wave 9** *(blocked on Wave 8 completion)*

- [x] 01-09-PLAN.md — NVENC copy-boundary spike, closed policy, and bounded parsers

**Wave 10** *(blocked on Wave 9 completion)*

- [x] 01-10-PLAN.md — Authenticated SDK 13.1 exact tuple probes, final G0, and current archive
...
|-------|----------------|--------|-----------|
| 1. Host Readiness Gate | 10/10 | In Progress|  |
